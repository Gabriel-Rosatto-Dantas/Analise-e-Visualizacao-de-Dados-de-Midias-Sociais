...
def main():
    ...
    while True:
        ...
        print("7. 📁 Ver Estrutura do Projeto")
        print("8. ❌ Sair")
        print("=" * 40)
        ...
        try:
            ...
            if opcao == '1':
                ...
                filename = f"reports/relatorio_marketing_digital_{datetime.now().strftime('%Y%m%d_%H%M%S')}.pdf"
                ...
                print("=" * 50)
                print("📦 Análise e Visualização de Dados de Mídias Sociais/")
                print("├── 🚀 run.py                    # Sistema principal")
                print("├── ⚙️  config.py                # Configurações")
                print("├── 📁 src/                      # Código fonte")
                print("│   ├── 📁 analyzers/            # Análise de dados")
                print("│   │   ├── kpi_analyzer.py")
                print("│   │   └── insights_generator.py")
                print("│   ├── 📁 visualizers/          # Visualizações")
                print("│   │   └── visualizations.py")
                print("│   ├── 📁 generators/           # Geração de dados")
                print("│   │   └── data_generator.py")
                print("│   └── 📁 dashboard/             # Dashboard interativo")
                print("│       └── dashboard.py")
                print("├── 📁 pipeline/                 # Pipeline de dados")
                print("│   └── report_generator.py")
                print("├── 📁 data/                     # Dados CSV")
                print("├── 📁 visualizations/           # Gráficos gerados")
                print("├── 📁 reports/                  # Relatórios PDF")
